...
def del_receiver(id):
    pop = "DELETE FROM tab_graphe_receiver WHERE id = " + str(id)+""
...
def give_pdf(tab):
    ...
    query = "UPDATE tab_receveur SET photo_araigne = 'asset/images/graphe_picture/receiver/graphe_receiver_" + \
...
pop = "SELECT * FROM tab_graphe_receiver LIMIT 1"
while(1):
