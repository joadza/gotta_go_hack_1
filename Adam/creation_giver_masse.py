...
for i in range(0, 40):
    ...
    req = "INSERT INTO `tab_donneur`(`id_donneur`, `photo_profil`, `age`, `sexual_orientation`, `origine`, `height`, `color_eyes`, `hair_color`, `hairiness`, `sport_week`, `leadership`, `humor`, `manual`, `literary`, `analytical_thinking`, `wittiness`, `donor_word`, `center_interest_3`, `center_interest_1`, `center_interest_2`) VALUES (NULL,'asset/images/"+str(i)+".jpg','"+str(
